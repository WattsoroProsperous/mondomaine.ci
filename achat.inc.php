...
<link rel="stylesheet" href="https://unicons.iconscout.com/release/v4.0.0/css/line.css">
	...
	<meta name="keywords" content="domaine en .ci" />
	<meta name="description" content="MT INVESTMENTS AND TECHNOLOGIES">
	<meta name="author" content="Amos.say">
							...
							<div class="header-column">
								<div class="header-row">
									<div class="header-logo">
										<a href="index.html">
											<img alt="Porto" width="400" height="300" src="img/MT_INVESTMENTS_AND_TECHNOLOGIES.png">
										</a>
									</div>
								</div>
							</div>
							<div class="header-column justify-content-end">
								<div class="header-row">
									<div class="header-nav header-nav-links">
										...
										<a href="" class="btn btn-modern btn-primary btn-outline btn-arrow-effect-1 text-capitalize text-2-5 ms-3 me-2 d-block d-md-none d-xl-block anim-hover-translate-right-5px transition-2ms">QUitter <i class="fas fa-arrow-right ms-2"></i></a>
